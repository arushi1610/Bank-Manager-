...
if __name__ == '__main__':
    ...
    while isSessionOn is True:
        ...
        for i in master_list:
            if i[2] == int(customerID):
                cust_accounts.append(i[1])
                isCustomer = True
        ...
        if isCustomer is True:
            ...
            while isAccountSelected is False:
                ...
                if int(account_type) in cust_accounts:
                    for x in master_list:
                        if int(account_type) == x[1]:
                            objectName = x[0]
                    ...
                    while isAccountSessionOn is True:
                        ...
                        if action_value == 2:
                            ...
                            #temp_str = amnt_to_withdraw

                            adjusted_amount = "%.2f" % float(amnt_to_withdraw)
